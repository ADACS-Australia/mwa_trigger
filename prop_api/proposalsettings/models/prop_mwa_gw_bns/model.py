...
class ProposalMwaGwBns(ProposalSettings):
    """
    Represents the settings for MWA GW BNS proposal.
    This class holds data and functions related to proposal settings for triggering
    observations on LIGO-Virgo-KAGRA BNS GW events.
    """
