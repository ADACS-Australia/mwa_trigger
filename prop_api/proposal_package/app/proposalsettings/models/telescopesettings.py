...
from ..config import ATCA_AUTH, PROJECT_PASSWORDS
from ..consts import *
...
class MWATelescopeSettings(BaseTelescopeSettings):
        ...
        **kwargs,
        ...
        try:
            if (
                ...
                json_logger.debug(
                    "Scheduling an ra/dec sub array observation",
                    extra={
                        "function": "MWATelescopeSettings.trigger_telescope",
                        "trig_id": proposal_decision_model.trig_id,
                        "event_id": event_id,
                ...
                json_logger.debug(
                    "Scheduling an ra/dec observation",
                    extra={
                        "function": "MWATelescopeSettings.trigger_telescope",
                        "trig_id": proposal_decision_model.trig_id,
                        "event_id": event_id,
            ...
            json_logger.error(
                "Error exception scheduling observation. decision: E ",
                extra={
                    "function": "MWATelescopeSettings.trigger_telescope",
                    "trig_id": proposal_decision_model.trig_id,
                    "event_id": event_id,
        ...
        if result is None:
            ...
            json_logger.error(
                "Error: no result from scheduling observation. decision: E ",
                extra={
                    "function": "MWATelescopeSettings.trigger_telescope",
                    "trig_id": proposal_decision_model.trig_id,
                    "event_id": event_id,
        ...
        if not result["success"]:
            ...
            json_logger.error(
                "Error: failed to schedule observation. decision: E ",
                extra={
                    "function": "MWATelescopeSettings.trigger_telescope",
                    "trig_id": proposal_decision_model.trig_id,
                    "event_id": event_id,
        ...
        json_logger.info(
            "Observation scheduled. decision: T",
            extra={
                "function": "MWATelescopeSettings.trigger_telescope",
                "trig_id": proposal_decision_model.trig_id,
                "event_id": event_id,
    ...
    def save_observation(self, context, trigger_id, obsid=None, reason=None) -> Dict:
        ...
        json_logger.info(
            "saving MWA observation",
            extra={
                "function": "MWATelescopeSettings.save_observation",
...
class ATCATelescopeSettings(BaseTelescopeSettings):
    ...
    def trigger_telescope(
        ...
        **kwargs,
        ...
        json_logger.info(
            "ATCA observation triggered successfully. decision: T",
            extra={
                "function": "ATCATelescopeSettings.trigger_telescope",
                "trig_id": proposal_decision_model.trig_id,
                "event_id": event_id,
