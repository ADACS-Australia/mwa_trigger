...
class ProposalSettings(models.Model):
    ...
    event_any_duration = models.BooleanField(
        default=False,
    ...
    maximum_position_uncertainty = models.FloatField(
        verbose_name="Maximum Position Uncertainty (deg)",
        help_text="A Event must have less than or equal to this position uncertainty to be observed.",
        default=0.05,
    )
    ...
    minimum_neutron_star_probability = models.FloatField(
    ...
    maximum_neutron_star_probability = models.FloatField(
    ...
    minimum_binary_neutron_star_probability = models.FloatField(
        verbose_name="Minimum probability for event to be BNS",
        help_text="",
        default=0.01,
    )
    ...
    minimum_neutron_star_black_hole_probability = models.FloatField(
        verbose_name="Minimum probability for event to be NSBH",
        help_text="",
        default=0.01,
    )
    ...
    minimum_binary_black_hole_probability = models.FloatField(
        verbose_name="Minimum probability for event to be BBH",
        help_text="",
        default=0.00,
    )
    ...
    minimum_terrestial_probability = models.FloatField(
    ...
    maximum_terrestial_probability = models.FloatField(
        verbose_name="Maximum probability for event to be terrestial",
        help_text="Limit on the probability that the source is terrestrial (i.e., a background noise fluctuation or a glitch)",
        default=0.95,
    )
    maximum_false_alarm_rate = models.CharField(
        default="1.00e-8",
        max_length=260,
    ...
    # MWA settings
    start_observation_at_high_sensitivity = models.BooleanField(
    ...
    atca_band_3mm_exptime = models.IntegerField(
        default=60,
    ...
    atca_band_7mm_exptime = models.IntegerField(
        default=60,
        verbose_name="Band Exposure Time (mins)",
        help_text="Total exposure time of the observation cycle at this frequency band.",
    )
    ...
    atca_band_4cm_exptime = models.IntegerField(
        default=60,
        verbose_name="Band Exposure Time (mins)",
        help_text="Total exposure time of the observation cycle at this frequency band.",
    )
    ...
    atca_min_exptime = models.IntegerField(
        default=30,
    ...
    atca_dec_min_1 = models.IntegerField(
        verbose_name="Declination min limit 1 (deg)",
        help_text="Only observe within this range",
        default=-90,
    )

    atca_dec_max_1 = models.IntegerField(
        verbose_name="Declination max limit 1 (deg)",
        help_text="Only observe within this range",
        default=-5,
    )

    atca_dec_min_2 = models.IntegerField(
        verbose_name="Declination min limit 2 (deg)",
        help_text="Only observe within this range",
        default=5,
    )

    atca_dec_max_2 = models.IntegerField(
