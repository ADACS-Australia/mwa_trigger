    ...
    for xml_file, xml_packet in xml_tests:
        ...
        if xml_file is None:
            ...
            yaml_loc = os.path.join(
                os.path.dirname(__file__), "test_events/Fermi_GRB.yaml"
            )
        else:
...
def test_parse_lvk_event():
    xml_tests = [
        (
            "LVC_real_early_warning.xml",
            None,
        ),
        (
            "LVC_real_preliminary.xml",
            None,
        ),
        (
            "LVC_real_initial.xml",
            None,
        ),
        (
            "LVC_real_update.xml",
